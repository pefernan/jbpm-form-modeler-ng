...
public class FormModelerServicesTest {
    ...
    public void createForm() throws Exception {
        ...
        DataHolderBuildConfig config = new DataHolderBuildConfig("string", "string", "string", "red", String.class.getName());
        ...
        config = new DataHolderBuildConfig("pojo1", "pojo1", "pojo1", "blue", Pojo1.class.getName());
